...
app.post('/api/punch-out', async (req, res) => {
    ...
    try {
        ...
        const rawHours = hoursWorked.rows[0].hours;
const hours = rawHours ? parseFloat(rawHours).toFixed(2) : '0.00';
...
app.listen(PORT, () => console.log(`Server running at http://16.170.255.161:${PORT}`));
